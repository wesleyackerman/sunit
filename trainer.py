...
class MUNIT_Trainer(nn.Module):
    ...
    def sample(self, x_a, x_b, n_random_codes=10):
        ...
        for i in range(x_a.size(0)):
            ...
            for n in range(n_random_codes):
                x_ab_rand[n].append(self.gen_b.decode(c_a, s_b_rand[n].unsqueeze(0)))
                x_ba_rand[n].append(self.gen_a.decode(c_b, s_a_rand[n].unsqueeze(0)))
        ...
        self.train()
        return (x_a, x_a_recon, x_ab1, x_ab2, *x_ab_rand, x_b, x_b_recon, x_ba1, x_ba2, *x_ba_rand)
    ...
    def sample_a(self, x_a, n_random_codes=10):
        ...
        for i in range(x_a.size(0)):
            ...
            for n in range(n_random_codes):
                x_ab_rand[n].append(self.gen_b.decode(c_a, s_b_rand[n].unsqueeze(0)))
                x_s_rand[n].append(self.gen_a.decode(c_a, s_a_rand[n].unsqueeze(0)))
        ...
        self.train()
        return (x_a, x_a_recon, x_ab1, x_ab2, *x_ab_rand), x_s_rand
    ...
    def sample_b(self, x_b, n_random_codes=10):
        ...
        for i in range(x_b.size(0)):
            ...
            for n in range(n_random_codes):
                x_ba_rand[n].append(self.gen_a.decode(c_b, s_a_rand[n].unsqueeze(0)))
                x_s_rand[n].append(self.gen_b.decode(c_b, s_b_rand[n].unsqueeze(0)))
        ...
        self.train()
        return (x_b, x_b_recon, x_ba1, x_ba2, *x_ba_rand), x_s_rand
    ...
    def resume(self, checkpoint_dir, hyperparameters):
        ...
        try:
            ...
            print("Error: Unable to load optimizers")
